...
/* |алгоритм фильтрации абонентов по времени внутригородских звонков| */
...
/* |алгоритм фильтрации абонентов по времени междугородних звонков| */
...
/* |алгоритм сортировки абонентов в алфавитном порядке| */
